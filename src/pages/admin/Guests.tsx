...
import {
  ...
  Users, Upload, Trash2, X, Copy, Check, ArrowLeft
} from 'lucide-react';
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '28px', flexWrap: 'wrap', gap: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <button onClick={() => navigate(`/admin/eventos/${id}`)}
            style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(184,150,90,0.1)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#230606', flexShrink: 0 }}>
            <ArrowLeft size={16} />
          </button>
          <div>
